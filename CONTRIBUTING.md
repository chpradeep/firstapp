# Contributing to Connected Dots
...
we use the git commit messages to **generate the [change log](https://github.com/tomastrajan/connected-dots/blob/master/CHANGELOG.md)**.
...
Even more [examples](https://github.com/tomastrajan/connected-dots/commits/master) of commit messages from commit history of this project.
