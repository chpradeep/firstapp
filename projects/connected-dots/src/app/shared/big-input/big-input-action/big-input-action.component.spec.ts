...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<iotfw-big-input-action></iotfw-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<iotfw-big-input-action [disabled]="true"></iotfw-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<iotfw-big-input-action fontSet="fas" fontIcon="fa-trash"></iotfw-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<iotfw-big-input-action label="delete"></iotfw-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<iotfw-big-input-action (action)="actionHandler()"></iotfw-big-input-action>';
    fixture = createHostComponent(template);
